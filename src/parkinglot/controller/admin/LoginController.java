...
public class LoginController {
	...
	public void checkCredentials(String email, String password) {
		...
		if (password.equals(model.getPassword())) {
			...
			adminHomeView.welcomeLabel
					.setText("<html><font color='white'>Welcome " + view.getTextField().getText() + "</font></html>");
			...
			if (frequentParkingUsersModel.gettotalFrequentParkers() > 0) {
				...
				adminHomeView.frequentParkers
						.setText(String.valueOf(frequentParkingUsersModel.gettotalFrequentParkers()));
			}
			view.dispose();
		} else {
